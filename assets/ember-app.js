        ...
        гость: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-гость', 'Гость', {
          регистрацКлюча: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-регистрац-ключа', '', {
            комната: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-комната', '', {
              номерКомнаты: (0, _attributes.attr)('Комната', { index: 1 })
            }, { index: -1, hidden: true }),
            карта: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-карта', '', {
              номерКарты: (0, _attributes.attr)('Карта', { index: 2 })
            }, { index: -1, hidden: true })
          }, { index: -1, hidden: true })
...
define('ember-app/mixins/regenerated/models/i-i-s-kursovaya-rabota-\u0433\u043E\u0441\u0442\u044C', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    ...
    modelClass.defineProjection('ГостьL', 'i-i-s-kursovaya-rabota-гость', {
      ...
      телефон: (0, _attributes.attr)('Телефон', { index: 3 }),
      почта: (0, _attributes.attr)('E-mail', { index: 4 }),
      регистрацКлюча: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-регистрац-ключа', 'Карта', {
        карта: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-карта', '', {
...
define('ember-app/mixins/regenerated/models/i-i-s-kursovaya-rabota-\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446-\u043A\u043B\u044E\u0447\u0430', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('РегистрацКлючаE', 'i-i-s-kursovaya-rabota-регистрац-ключа', {
      комната: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-комната', 'Номер комната', {}, { index: 0, displayMemberPath: 'номерКомнаты' }),
      карта: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-карта', 'Номер карты', {}, { index: 1, displayMemberPath: 'номерКарты' }),
      считыватель: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-считыватель', 'Уникальный код', {}, { index: 2, displayMemberPath: 'уникальныйКод' }),
      сотрудник: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-сотрудник', 'Ответственный', {}, { index: 3, displayMemberPath: 'фИО' })
    });
    ...
    modelClass.defineProjection('РегистрацКлючаL', 'i-i-s-kursovaya-rabota-регистрац-ключа', {
      ...
      карта: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-карта', 'Номер карты', {
        номерКарты: (0, _attributes.attr)('Номер карты', { index: 1 })
      }, { index: -1, hidden: true }),
      считыватель: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-считыватель', 'Уникальный код', {
        уникальныйКод: (0, _attributes.attr)('Уникальный код', { index: 2 })
      }, { index: -1, hidden: true }),
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        ...
        'i-i-s-kursovaya-rabota-регистрац-ключа': 'id,карта,комната,сотрудник,считыватель',
...
define("ember-app/templates/i-i-s-kursovaya-rabota-\u043A\u0430\u0440\u0442\u0430-e", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "zalJLvKx", "block": "{\"symbols\":[],\"statements\":[[6,\"h3\"],[10,\"class\",\"ui header\"],[8],[1,[26,\"t\",[\"forms.i-i-s-kursovaya-rabota-карта-e.caption\"],null],false],[9],[0,\"\\n\\n\"],[6,\"form\"],[10,\"class\",\"ui form flexberry-vertical-form\"],[10,\"role\",\"form\"],[8],[0,\"\\n  \"],[1,[26,\"flexberry-error\",null,[[\"error\"],[[22,[\"error\"]]]]],false],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field\"],[8],[0,\"\\n    \"],[6,\"div\"],[10,\"class\",\"flexberry-edit-panel\"],[8],[0,\"\\n\"],[4,\"unless\",[[22,[\"readonly\"]]],null,{\"statements\":[[0,\"        \"],[6,\"button\"],[10,\"class\",\"ui button save-button\"],[3,\"action\",[[21,0,[]],\"save\"]],[8],[0,\"\\n          \"],[1,[26,\"t\",[\"forms.edit-form.save-button-text\"],null],false],[0,\"\\n        \"],[9],[0,\"\\n\"],[4,\"unless\",[[22,[\"model\",\"isNew\"]]],null,{\"statements\":[[0,\"          \"],[6,\"button\"],[10,\"class\",\"ui button save-del-button\"],[3,\"action\",[[21,0,[]],\"delete\"]],[8],[0,\"\\n            \"],[1,[26,\"t\",[\"forms.edit-form.delete-button-text\"],null],false],[0,\"\\n          \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[0,\"      \"],[6,\"button\"],[10,\"class\",\"ui button close-button\"],[3,\"action\",[[21,0,[]],\"close\"]],[8],[0,\"\\n        \"],[1,[26,\"t\",[\"forms.edit-form.close-button-text\"],null],false],[0,\"\\n      \"],[9],[0,\"\\n    \"],[9],[0,\"\\n  \"],[9],[0,\"\\n  \"],[6,\"div\"],[10,\"class\",\"field flexberry-validationsummary-container\"],[8],[0,\"\\n    \"],[6,\"div\"],[10,\"class\",\"sixteen wide\"],[8],[0,\"\\n      \"],[1,[26,\"flexberry-validationsummary\",null,[[\"errors\"],[[26,\"get\",[[22,[\"validationObject\",\"validations\"]],\"messages\"],null]]]],false],[0,\"\\n    \"],[9],[0,\"\\n  \"],[9],[0,\"\\n\\n\"],[9],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-app/templates/i-i-s-kursovaya-rabota-карта-e.hbs" } });
});
